...
public class Tokenizer {
    ...
    private Token lexIdentOrKeyword() throws TokenizeError {
        ...
        if(nowToken_s.equals("begin")) return new Token(TokenType.Begin, nowToken_s, startpos, it.previousPos());
        else if(nowToken_s.equals("end")) return new Token(TokenType.End, nowToken_s, startpos, it.previousPos());
        else if(nowToken_s.equals("var")) return new Token(TokenType.Var, nowToken_s, startpos, it.previousPos());
        else if(nowToken_s.equals("print")) return new Token(TokenType.Print, nowToken_s, startpos, it.previousPos());
